      ...
      <Container className="relative z-10 lg:py-16">
        ...
        <div className="flex h-full items-end">
          <div className="w-full space-y-10 rounded-t-3xl bg-white/20 p-10 backdrop-blur-2xl lg:w-1/2 lg:rounded-3xl">
            <h1 className="text-2xl leading-[1.4] font-bold lg:text-4xl">
            ...
            <Dialog>
              <DialogTrigger className="px-auto w-full cursor-pointer rounded-2xl bg-[#cb5dff] py-5 text-base font-bold hover:opacity-90 lg:w-fit lg:px-24 lg:text-2xl">
                OPEN APP
              </DialogTrigger>
